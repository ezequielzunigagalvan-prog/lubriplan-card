          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ background: '#13112a', borderRadius: 12, border: '1px solid #2a2850', padding: '16px 16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <button onClick={() => navigate('/admin/historico-lubricaciones')} style={{ padding: '10px 14px', borderRadius: 8, border: '1px solid #2a2850', background: 'transparent', color: '#22C55E', fontSize: 13, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif", textAlign: 'left', fontWeight: 600 }}>
                  📊 Ver histórico de lubricaciones →
                </button>
